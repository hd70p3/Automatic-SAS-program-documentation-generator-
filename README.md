...
To install Engrafo SAS Analyzer we have created an installer that has to 
...
If you need a binary installation version, it is here: [Engrafo Installer](https://www.engrafo.eu/EngrafoVersions/EngrafoInstaller2.0.zip)

***What is Engrafo SAS Analyzer***

> Engrafo SAS analyzer module is a data catalog tool automatically
...
> 
> With Engrafo SAS Analyzer you get a complete overview of the use of
> all the different  SAS procedures used in active SAS programs.  Get
...
>- What procedures comsume the most
>- CPU-time/real-time?  
